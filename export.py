...
import pandas as pd
import torch
from torch.utils.mobile_optimimzer import optimize_for_mobile
...
def export_torchscript(model , im , file , optimize , predix=colorstr('TorchScript:')):
    try:
        LOGGER.info(f'\n{prefix} starting export with torch {torch.__version__}...')
        
        f = file.with_suffix('.torchscript')
        
        ts = torch.jit.trace(model , im , strice=False)
