...
class TransformerLayer(nn.Module):
    def __init__(self , 
        ...
        self.fc1 = nn.Lienar(c , c , bias=False)
...
class BottlenecSCP(nn.Module):
    def __init__(self , 
        ...
        self.cv3 = nn.Conv2d(c1 , c_ , 1 , 1 , bias=False)
...
class C3Ghost(C3):
    def __init__(self , 
                 ...
                 g=1 , 
                 e=0.5):
        super(C3Ghost , self).__init__(c1 , c2 , n , shortcut , g , e)
        c_ = int(c2 * e)
...
class Focus(nn.Module):
    def __init__(self , 
        ...
        self.cv = Conv(c1 * 4 , c2 , k , s, p , g , act)
